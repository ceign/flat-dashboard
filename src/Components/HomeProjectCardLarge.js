...
import "../Components/HomeProjectCardLarge.css";
import projectLogo from "../Assets/Images/project-logo.png";

const HomeProjectCardLarge = () => {
  return (
    <div className="home__projects-card-large">
      <div className="home__projects-card-large__wrapper">
        <div className="home__projects-card-large__header">
          <div className="home__projects-card-large__image">
            <figure>
        ...
        <div className="home__projects-card-large__footer">
          <button>
            Ver más
            <span>
              <svg
...
export default HomeProjectCardLarge;
